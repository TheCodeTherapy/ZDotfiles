...
link_dotfiles() {
  ...
  declare -A files_to_link=(
    ...
    ["${DOTDOT}/themes/Nordic/kde/kvantum/Nordic-Darker"]="$target_config/Kvantum/Nordic-Darker"
    ["${DOTDOT}/themes/Nordic/kde/kvantum/Nordic-Darker-Solid"]="$target_config/Kvantum/Nordic-Darker-Solid"
    ["${DOTDOT}/themes/Nordic/kde/kvantum/Nordic-Solid"]="$target_config/Kvantum/Nordic-Solid"
    ["${DOTDOT}/themes/kvantum.kvconfig"]="$target_config/Kvantum/kvantum.kvconfig"
